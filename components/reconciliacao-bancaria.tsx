...
import { Printer, Upload, FileDown, Search, X, RefreshCw } from "lucide-react"
          ...
          <div className="space-y-6">
            <div className="flex flex-col sm:flex-row gap-4 items-end">
              ...
              <div className="w-full sm:w-auto">
                ...
                <Select value={matchAutomatico ? "sim" : "nao"} onValueChange={(v) => setMatchAutomatico(v === "sim")}>
                  <SelectTrigger className="w-[200px]">
                  ...
                  {transacoesFiltradas.length > 0 ? (
                    transacoesFiltradas.map((transacao, index) => {
                      ...
                      return (
                        <TableRow key={transacao.id} className={index % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                          ...
                          {/* Modificar a exibição na tabela para mostrar o método de pagamento */}
                          {/* Na parte do TableBody, dentro do mapeamento de transacoesFiltradas: */}
                          <TableCell>
                            <Badge
                              variant="outline"
                              className={
                    ...
                    <TableRow>
                      <TableCell colSpan={7} className="text-center py-4">
                        {transacoes.length === 0
                          ? "Nenhum extrato bancário carregado. Carregue um arquivo Excel para começar."
